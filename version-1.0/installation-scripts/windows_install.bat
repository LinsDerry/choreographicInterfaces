...
..\TMenv\Scripts\pip install tensorflow
:: ..\TMenv\Scripts\pip install tensorflow==2.0.0 
..\TMenv\Scripts\pip install scikit-image
..\TMenv\Scripts\pip install imutils
..\TMenv\Scripts\pip install pyautogui
..\TMenv\Scripts\\pip install cmake
..\TMenv\Scripts\pip install dlib
deactivate
