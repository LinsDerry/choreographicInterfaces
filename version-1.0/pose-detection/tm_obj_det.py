...
if __name__ == '__main__':
    ...
    labels_path = "./converted_keras_newest/labels.txt" # UPDATE TO CORRECT RELATIVE PATH
    ...
    model_path = './converted_keras_newest/keras_model.h5' # UPDATE TO CORRECT RELATIVE PATH
        ...
        for i in range(0, len(classes)):
            ...
            if confidence[i] > conf_threshold:
                ...
                if i == 2: # select
                    ...
                    pyautogui.hotkey('command', 'r') # refresh browser page
                    continue
