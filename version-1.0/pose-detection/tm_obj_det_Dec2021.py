...
if __name__ == '__main__':
    ...
    detector = dlib.simple_object_detector("1750_detector.svm") # UPDATE AS NEEDED
    ...
    while True:
        ...
        for i in range(0, len(classes)):
            ...
            if confidence[i] > conf_threshold:
                ...
                print(f'Threshold class is {threshold_class}')
                ...
                if confidence[i] > conf_threshold:
                    ...
                    if i == 0: # neutral
                        ...
                        continue # track i.e. do nothing

                    elif i == 2:
                        action_triggered = 1
                        pyautogui.click(button='left') # select/click
                        time_elapsed = 0
                        start_timer = 1
                        continue
        ...
        toc = time.perf_counter()
        print(f"While loop took: {toc - tic:0.4f} seconds")
